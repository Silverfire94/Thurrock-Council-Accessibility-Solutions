        ...
        value: function speak(data) {
          ...
          return new Promise(function(resolve, reject) {
            ...
            sentences.forEach(function(sentence, index) {
              ...
              if (_this3.volume) utterance.volume = _this3.volume;
              if (_this3.rate) utterance.rate = _this3.rate;
              if (_this3.pitch) utterance.pitch = _this3.pitch;
